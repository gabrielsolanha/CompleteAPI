...
using Completeapi.CsharpModel.Domain.Specifications;
using Completeapi.CsharpModel.Unit.Domain.Specifications.TestData;
using FluentAssertions;
using Xunit;

namespace Completeapi.CsharpModel.Unit.Domain.Specifications
{
