...
dotnet restore Completeapi.CsharpModel.sln
dotnet build Completeapi.CsharpModel.sln --configuration Release --no-restore

REM Run tests with coverage
dotnet test Completeapi.CsharpModel.sln --no-restore --verbosity normal ^
